"""
Django settings for toefl_practice project.
...
CSRF_TRUSTED_ORIGINS = security.get("csrf_trusted_origins", [])
DEBUG = False
...
ROOT_URLCONF = 'toefl_practice.urls'
...
WSGI_APPLICATION = 'toefl_practice.wsgi.application'
